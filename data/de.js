export const subtypeProfiles = {
  ...
  se2: {
    meinKompass: {
      ...
      grundstrategie: "Bindung über Fürsorge und Verfügbarkeit absichern. Sich stark nach den Bedürfnissen anderer richten und eigene Wünsche zurückhalten. Kernsatz: „Wenn du deine eigenen Bedürfnisse ernst nimmst, entsteht Nähe ohne Erwartung.“",
      staerken: [
      "warme Ausstrahlung",
      ...
      herausforderungen: [
      "Sich um andere kümmern, um Nähe und Zuwendung zu erhalten, während die eigenen Bedürfnisse überse…",
  ...
  se3: {
    meinKompass: {
      ...
      grundstrategie: "Sicherheit über Leistung und Kontrolle gewinnen wollen. Gefühle und Bedürfnisse zurückhalten und sich stark auf Funktionieren ausrichten. Kernsatz: „Wenn du aufhörst, nur zu funktionieren, erscheint dein Wert ohne Leistung und Anpassung.“",
      staerken: [
  ...
  se4: {
    meinKompass: {
      ...
      grundstrategie: "Schmerz und Enttäuschung innerlich festhalten. Sich zurückziehen, wenn Verletzung oder Missverstehen auftaucht. Kernsatz: „Wenn du Schmerz nicht still beweisen musst, entsteht würdevolle Lebendigkeit und innere Kraft.“",
      staerken: [
  ...
  se5: {
    meinKompass: {
      ...
      grundstrategie: "Abstand halten und Rückzug bewahren. Vereinnahmung vermeiden und Energie, Gefühle und Bedürfnisse stark kontrollieren. Kernsatz: „Wenn du dem Leben wieder Zugang gewährst, entsteht Sicherheit ohne ständigen Rückzug.“",
      staerken: [
      "ruhiger Atem",
      "fokussierter Blick",
      "ressourcenschonend",
  ...
  se6: {
    meinKompass: {
      ...
      grundstrategie: "Sicherheit durch Kontrolle und Vorbereitung herstellen. Den Blick stark auf mögliche Risiken richten und Anspannung innerlich halten. Kernsatz: „Wenn du deinem Körper vertraust, entsteht Ruhe, auch wenn nicht alles sicher ist.“",
      staerken: [],
      herausforderungen: [
  ...
  se7: {
    meinKompass: {
      ...
      grundstrategie: "Sicherheit durch Möglichkeiten, Ideen und positive Perspektiven suchen Kernsatz: „Wenn du genug hast, ohne mehr zu brauchen, entsteht wirklicher Genuss und innere Ruhe.“",
      staerken: [],
      herausforderungen: [
  ...
  se8: {
    meinKompass: {
      ...
      grundstrategie: "Die Umgebung kontrollieren, um Schwäche und Abhängigkeit zu vermeiden Kernsatz: „Wenn du Kontrolle loslässt, bleibt deine Kraft lebendig, klar und ohne Härte.“",
      staerken: [],
      herausforderungen: [
  ...
  se9: {
    meinKompass: {
      ...
      grundstrategie: "Konflikte vermeiden und Gewohntes aufrechterhalten, um innere Ruhe zu bewahren Kernsatz: „Wenn du dich selbst wichtig nimmst und nicht betäubst, entsteht lebendige innere Präsenz.“",
      staerken: [],
      herausforderungen: [
  ...
  so1: {
    meinKompass: {
      ...
      grundstrategie: "Starke Orientierung an Regeln, Werten und moralischer Klarheit. Sich und andere kontrollieren, um Fehler oder falsches Verhalten zu vermeiden. Kernsatz: „Wenn du Vorbild bist, ohne zu richten, entsteht Würde, Klarheit und natürliche Autorität.“",
      staerken: [
      "ruhiger Atem",
      "entspannter Kiefer",
      "weichere Stirn",
  ...
  so2: {
    meinKompass: {
      ...
      grundstrategie: "Über Nähe und Fürsorge sozialen Wert gewinnen. Sich stark an Erwartungen anderer anpassen und eigene Bedürfnisse zurückhalten. Kernsatz: „Wenn du nicht gebraucht werden musst, wird deine Liebe frei, großzügig und liebevoll.“",
      staerken: [
      "warme Ausstrahlung",
      "empathisches Gespür",
  ...
  so3: {
    meinKompass: {
      ...
      grundstrategie: "Über Leistung und Wirkung den eigenen Wert absichern. Sich stark an Erwartungen und Erfolgsbilder anpassen. Kernsatz: „Wenn du nicht glänzen musst, wird deine Wirkung wahrhaftig, menschlich und stark.“",
      staerken: [
      "starke Ausstrahlung",
  ...
  so4: {
    meinKompass: {
      ...
      grundstrategie: "Über Besonderheit und Gefühlstiefe deinen Platz sichern wollen. Anderssein sichtbar machen und darüber Resonanz und Zugehörigkeit suchen. Kernsatz: „Wenn du deinen Mangel nicht festhältst, entsteht Zugehörigkeit, Selbstannahme und stille Würde.“",
      staerken: [
      "tiefer innerer Rückzug",
      "reiche Gefühlswelt",
      "authentischer Ausdruck",
  ...
  so5: {
    meinKompass: {
      ...
      grundstrategie: "Sicherheit über Wissen und geistige Klarheit gewinnen. Menschen und Systeme lieber aus der Distanz beobachten und Gefühle zurückhalten. Kernsatz: „Wenn Wissen nicht über Menschen steht, entsteht wirkliche Weisheit und lebendiger Kontakt.“",
      staerken: [
      "ruhige Präsenz",
  ...
  so6: {
    meinKompass: {
      ...
      grundstrategie: "Sicherheit über Orientierung, Regeln und Zugehörigkeit gewinnen. Menschen und Situationen genau prüfen und Zweifel stark kontrollieren. Kernsatz: „Wenn Regeln nicht dein Gewissen ersetzen, entsteht innere Standfestigkeit und Freiheit.“",
      staerken: [],
      herausforderungen: [
  ...
  so7: {
    meinKompass: {
      ...
      grundstrategie: "Leichtigkeit, Ideen und Möglichkeiten in Gruppen einbringen und dabei Tiefe, Schmerz und Begrenzung ausweichen Kernsatz: „Wenn du nicht gut sein musst, wird deine Freude ehrlich, frei und nahbar.“",
      staerken: [],
      herausforderungen: [
  ...
  so8: {
    meinKompass: {
      ...
      grundstrategie: "Verantwortung und Stärke für andere übernehmen Kernsatz: „Wenn Schutz nicht Besitz wird, entsteht starke, gerechte und vertrauensvolle Führung.“",
      staerken: [],
      herausforderungen: [
  ...
  so9: {
    meinKompass: {
      ...
      grundstrategie: "Zugehörigkeit und Harmonie in Gruppen suchen und die eigene Position hinten anstellen Kernsatz: „Wenn Zugehörigkeit nicht Selbstvergessenheit bedeutet, entsteht echte und stabile Gemeinschaft.“",
      staerken: [],
      herausforderungen: [
  ...
  sx1: {
    meinKompass: {
      ...
      grundstrategie: "Gefühle und Spannungen verstärken, um Verbindung lebendig zu halten. Empfindlich auf Distanz oder Unstimmigkeiten reagieren. Kernsatz: „Wenn du dein Feuer nicht bekämpfst, sondern bewusst führst, wird Leidenschaft klar und heilsam.“",
      staerken: [
  ...
  sx2: {
    meinKompass: {
      ...
      grundstrategie: "Über besondere Nähe emotionale Bedeutung bekommen wollen. Sich stark an einzelne Menschen binden und dabei leicht Eigenständigkeit verlieren. Kernsatz: „Wenn du Liebe nicht erobern musst, kann echte Verbundenheit dich wirklich erreichen.“",
      staerken: [
  ...
  sx3: {
    meinKompass: {
      ...
      grundstrategie: "Über Ausstrahlung und Wirkung Anerkennung bekommen wollen. Sich stark an Wünschen und Idealen anderer anpassen, um begehrt und bewundert zu werden. Kernsatz: „Wenn du dich nicht inszenieren musst, entsteht echte Ausstrahlung aus innerem Wert.“",
      staerken: [
      "starke Ausstrahlung",
      "begeisterungsfähig",
  ...
  sx4: {
    meinKompass: {
      ...
      grundstrategie: "Über Intensität und starke Gefühle Verbindung sichern wollen. Sehnsucht, Verletzung und Spannung sichtbar machen und darin Resonanz suchen. Kernsatz: „Wenn du Intensität nicht erzwingen musst, wird Tiefe zu Liebe ohne Drama.“",
      staerken: [
  ...
  sx5: {
    meinKompass: {
      ...
      grundstrategie: "Nähe nur sehr kontrolliert zulassen. Menschen aufmerksam beobachten und die Innenwelt lange verborgen halten. Kernsatz: „Wenn du dich nicht nur im Geheimen öffnest, wird Nähe tragfähig und frei.“",
      staerken: [
      "feine Wahrnehmung",
      "emotionale Tiefe",
  ...
  sx6: {
    meinKompass: {
      ...
      grundstrategie: "Sicherheit über Stärke, Kontrolle und intensive Bindung herstellen. Nähe und Vertrauen ständig prüfen und empfindlich auf Unsicherheit oder Distanz reagieren. Kernsatz: „Wenn du nicht kämpfen musst, um sicher zu sein, entsteht Mut und Vertrauen.“",
      staerken: [],
      herausforderungen: [
  ...
  sx7: {
    meinKompass: {
      ...
      grundstrategie: "Intensive Erfahrungen, Inspiration und Begeisterung suchen Kernsatz: „Wenn du Tiefe zulässt, statt das Besondere zu jagen, entsteht echte Erfüllung.“",
      staerken: [],
      herausforderungen: [
  ...
  sx8: {
    meinKompass: {
      ...
      grundstrategie: "Intensive Begegnung, Wahrheit und direkte Konfrontation suchen Kernsatz: „Wenn du Intensität nicht mit Kampf verwechselst, entsteht Nähe und Vertrauen ohne Machtprobe.“",
      staerken: [],
      herausforderungen: [
  ...
  sx9: {
    meinKompass: {
      ...
      grundstrategie: "Sich leicht in anderen verlieren und anpassen, um Harmonie zu bewahren Kernsatz: „Wenn Verschmelzung nicht zum Selbstverlust führt, kann Liebe wirklich zur Begegnung werden.“",
      staerken: [],
      herausforderungen: [
