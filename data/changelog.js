...
var CHANGELOG = [
    { version: "v773", date: "2026-07-31", text: "Fix: Reihenfolge in der Kriminalfälle-Übersicht korrigiert – Frank Abagnale Jr. stand nach der SO7w6-Typkorrektur noch mitten im SE3-Block, wodurch auch Bernie Madoff verschoben wurde. Beide jetzt in ihrer korrekten Subtyp-Gruppe.", text_en: "Fix: Ordering in the Criminal Cases overview corrected – after the SO7w6 retyping, Frank Abagnale Jr. was still sitting in the middle of the SE3 block, displacing Bernie Madoff as well. Both now sit in their correct subtype group.", route: "kriminalpsychologie" },
    { version: "v772", date: "2026-07-31", text: "Fix: Rubrik \"Spannende Kriminalfälle\" zeigte 0 von 73 Porträts – eine doppelte, unvollständige Filter-Initialisierung (fehlendes Geschlechts-Feld) verhinderte jede Anzeige. Behoben.", text_en: "Fix: The \"Criminal Cases\" section showed 0 of 73 portraits – a duplicate, incomplete filter initialization (missing gender field) prevented any display. Fixed.", route: "kriminalpsychologie" },
    { version: "v771", date: "2026-07-30", text: "Korrektur: Frank Abagnale Jr. (Kriminalpsychologie) war fälschlich als SE3w4 getypt, korrekt ist SO7w6 (Soziale Sieben mit Sechserflügel). Porträt komplett neu geschrieben, alle Verweise in anderen Porträts aktualisiert.", text_en: "Correction: Frank Abagnale Jr. (Criminal Psychology) was mistyped as SE3w4, correct is SO7w6 (Social Seven with Six-wing). Portrait completely rewritten, all references in other portraits updated.", route: "kriminalpsychologie-frank-abagnale-jr" },
